...
const App = () => {
  ...
  const downloadElementById = useCallback((id)=>{
  ...
  return (
    <BrowserRouter>
      ...
      <Route exact path="/post/:id" render={() => <PostDetail isLoading={isLoading} list={list} downloadElementById={downloadElementById} />} />
      </BrowserRouter>
  );
};
export default App;
